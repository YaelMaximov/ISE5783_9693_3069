...
class SphereTests {
    ...
    public void findIntersectionsSphere() throws IllegalAccessException
    {
        ...
        assertNull(sphere4.findIntsersections(new Ray(new Point(-1,0,0),new Vector(1,1,0))),"Ray's line out of sphere");
        ...
        List<Point>numPoin1=sphere4.findIntsersections(new Ray(new Point(1,0.5,0),new Vector(1,1,0)));
        ...
        List<Point> numberPoint2=sphere4.findIntsersections(new Ray(new Point(2,4,0),new Vector(2,6,0)));
        assertNull(numberPoint2,"Ray starts after the sphere");

        // =============== Boundary Values Tests ==================
        // TC11: Ray starts at sphere and goes inside(1 points)
        List<Point>numberPoint3=sphere4.findIntsersections(new Ray(new Point(0,0,0),new Vector(1.6,0.5,0)));
        ...
        List<Point>numberPoint1=sphere4.findIntsersections(new Ray(new Point(0,0,0),new Vector(0,1,0)));
        ...
        List<Point>pointList1=sphere4.findIntsersections(new Ray(new Point(3,0,0),new Vector(4,0,0)));
        ...
        List<Point>numPoint5=sphere4.findIntsersections(new Ray(new Point(0.5,1,0),new Vector(0.2,1,0)));
        assertNull(numPoint5,"Ray starts after the tangent point");

        // **** Group: Special cases
        // TC19: Ray's line is outside, ray is orthogonal to ray start to sphere's center line
        List<Point>numPoint6=sphere4.findIntsersections(new Ray(new Point(1,2,0),new Vector(0.5,2,0)));
