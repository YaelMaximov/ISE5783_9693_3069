...
class PointTests {
    ...
    public void testAdd() throws IllegalAccessException {
        ...
        assertEquals(vector.add(vector1),vector2,"ERROR:wrong point add");
    ...
    void testSubtract() throws IllegalAccessException {
        // ============ Equivalence Partitions Tests ==============
        //TC01:simple test
        assertEquals(new Vector(3,3,3).subtract(new Point(1,1,1)),new Vector(2,2,2),"ERROR:wrong point subtract");
        // =============== Boundary Values Tests ==================
        //TC11:test subtracting same point
        assertThrows(IllegalArgumentException.class,()->new Point(1,2,3).subtract(new Point(1,2,3)),"Subtract P from throw exception");
